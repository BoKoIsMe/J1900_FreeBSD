      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	main.c:14: led=0x01;
      000062 75 80 01         [24]  372 	mov	_P0,#0x01
                                    373 ;	main.c:15: delay(50000);
      000065 90 C3 50         [24]  374 	mov	dptr,#0xc350
      000068 12 00 BC         [24]  375 	lcall	_delay
                                    376 ;	main.c:18: for(i=0;i<8;i++)
      00006B                        377 00112$:
      00006B 7F 00            [12]  378 	mov	r7,#0x00
      00006D                        379 00106$:
                                    380 ;	main.c:20: led=(0x01<<i);
      00006D 8F 06            [24]  381 	mov	ar6,r7
      00006F 8E F0            [24]  382 	mov	b,r6
      000071 05 F0            [12]  383 	inc	b
      000073 74 01            [12]  384 	mov	a,#0x01
      000075 80 02            [24]  385 	sjmp	00131$
      000077                        386 00129$:
      000077 25 E0            [12]  387 	add	a,acc
      000079                        388 00131$:
      000079 D5 F0 FB         [24]  389 	djnz	b,00129$
      00007C F5 80            [12]  390 	mov	_P0,a
                                    391 ;	main.c:21: delay(50000);
      00007E 90 C3 50         [24]  392 	mov	dptr,#0xc350
      000081 C0 07            [24]  393 	push	ar7
      000083 12 00 BC         [24]  394 	lcall	_delay
      000086 D0 07            [24]  395 	pop	ar7
                                    396 ;	main.c:18: for(i=0;i<8;i++)
      000088 0F               [12]  397 	inc	r7
      000089 BF 08 00         [24]  398 	cjne	r7,#0x08,00132$
      00008C                        399 00132$:
      00008C 40 DF            [24]  400 	jc	00106$
                                    401 ;	main.c:24: for(i=0;i<8;i++)
      00008E 7F 00            [12]  402 	mov	r7,#0x00
      000090                        403 00108$:
                                    404 ;	main.c:26: led=(0x80>>i);
      000090 8F F0            [24]  405 	mov	b,r7
      000092 05 F0            [12]  406 	inc	b
      000094 7D 80            [12]  407 	mov	r5,#0x80
      000096 E4               [12]  408 	clr	a
      000097 FE               [12]  409 	mov	r6,a
      000098 33               [12]  410 	rlc	a
      000099 92 D2            [24]  411 	mov	ov,c
      00009B 80 08            [24]  412 	sjmp	00135$
      00009D                        413 00134$:
      00009D A2 D2            [12]  414 	mov	c,ov
      00009F EE               [12]  415 	mov	a,r6
      0000A0 13               [12]  416 	rrc	a
      0000A1 FE               [12]  417 	mov	r6,a
      0000A2 ED               [12]  418 	mov	a,r5
      0000A3 13               [12]  419 	rrc	a
      0000A4 FD               [12]  420 	mov	r5,a
      0000A5                        421 00135$:
      0000A5 D5 F0 F5         [24]  422 	djnz	b,00134$
      0000A8 8D 80            [24]  423 	mov	_P0,r5
                                    424 ;	main.c:27: delay(50000);
      0000AA 90 C3 50         [24]  425 	mov	dptr,#0xc350
      0000AD C0 07            [24]  426 	push	ar7
      0000AF 12 00 BC         [24]  427 	lcall	_delay
      0000B2 D0 07            [24]  428 	pop	ar7
                                    429 ;	main.c:24: for(i=0;i<8;i++)
      0000B4 0F               [12]  430 	inc	r7
      0000B5 BF 08 00         [24]  431 	cjne	r7,#0x08,00136$
      0000B8                        432 00136$:
      0000B8 40 D6            [24]  433 	jc	00108$
                                    434 ;	main.c:30: }
      0000BA 80 AF            [24]  435 	sjmp	00112$
                                    436 ;------------------------------------------------------------
                                    437 ;Allocation info for local variables in function 'delay'
                                    438 ;------------------------------------------------------------
                                    439 ;i                         Allocated to registers 
                                    440 ;------------------------------------------------------------
                                    441 ;	main.c:32: void delay(u16 i)
                                    442 ;	-----------------------------------------
                                    443 ;	 function delay
                                    444 ;	-----------------------------------------
      0000BC                        445 _delay:
      0000BC AE 82            [24]  446 	mov	r6,dpl
      0000BE AF 83            [24]  447 	mov	r7,dph
                                    448 ;	main.c:34: while(i)
      0000C0                        449 00101$:
      0000C0 EE               [12]  450 	mov	a,r6
      0000C1 4F               [12]  451 	orl	a,r7
      0000C2 60 07            [24]  452 	jz	00104$
                                    453 ;	main.c:35: i--;
      0000C4 1E               [12]  454 	dec	r6
      0000C5 BE FF 01         [24]  455 	cjne	r6,#0xff,00114$
      0000C8 1F               [12]  456 	dec	r7
      0000C9                        457 00114$:
      0000C9 80 F5            [24]  458 	sjmp	00101$
      0000CB                        459 00104$:
                                    460 ;	main.c:36: }
      0000CB 22               [24]  461 	ret
                                    462 	.area CSEG    (CODE)
                                    463 	.area CONST   (CODE)
                                    464 	.area XINIT   (CODE)
