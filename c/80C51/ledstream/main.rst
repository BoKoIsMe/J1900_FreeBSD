                                      ...
                                      4 ; This file was generated Tue Mar 13 20:32:33 2018
                                      5 ;--------------------------------------------------------
                                      6 	.module main
      ...
      000062                        363 _main:
                           ...
                           000001   370 	ar1 = 0x01
                           000000   371 	ar0 = 0x00
                                    372 ;	./main.c:14: led=0x01;
      000062 75 80 01         [24]  373 	mov	_P0,#0x01
                                    374 ;	./main.c:15: delay(50000);
      000065 90 C3 50         [24]  375 	mov	dptr,#0xC350
      000068 12 00 AF         [24]  376 	lcall	_delay
                                    377 ;	./main.c:18: for(i=0;i<8;i++)
      00006B                        378 00112$:
      00006B 7F 00            [12]  379 	mov	r7,#0x00
      00006D                        380 00106$:
                                    381 ;	./main.c:20: led=(0x01<<i);
      00006D 8F F0            [24]  382 	mov	b,r7
      00006F 05 F0            [12]  383 	inc	b
      000071 74 01            [12]  384 	mov	a,#0x01
      000073 80 02            [24]  385 	sjmp	00131$
      000075                        386 00129$:
      000075 25 E0            [12]  387 	add	a,acc
      000077                        388 00131$:
      000077 D5 F0 FB         [24]  389 	djnz	b,00129$
      00007A F5 80            [12]  390 	mov	_P0,a
                                    391 ;	./main.c:21: delay(50000);
      00007C 90 C3 50         [24]  392 	mov	dptr,#0xC350
      00007F C0 07            [24]  393 	push	ar7
      000081 12 00 AF         [24]  394 	lcall	_delay
      000084 D0 07            [24]  395 	pop	ar7
                                    396 ;	./main.c:18: for(i=0;i<8;i++)
      000086 0F               [12]  397 	inc	r7
      000087 BF 08 00         [24]  398 	cjne	r7,#0x08,00132$
      00008A                        399 00132$:
      00008A 40 E1            [24]  400 	jc	00106$
                                    401 ;	./main.c:24: for(i=0;i<8;i++)
      00008C 7F 00            [12]  402 	mov	r7,#0x00
      00008E                        403 00108$:
                                    404 ;	./main.c:26: led=(0x80>>i);
      00008E 8F F0            [24]  405 	mov	b,r7
      000090 05 F0            [12]  406 	inc	b
      000092 74 80            [12]  407 	mov	a,#0x80
      000094 80 02            [24]  408 	sjmp	00135$
      000096                        409 00134$:
      000096 C3               [12]  410 	clr	c
      000097 13               [12]  411 	rrc	a
      000098                        412 00135$:
      000098 D5 F0 FB         [24]  413 	djnz	b,00134$
      00009B F5 80            [12]  414 	mov	_P0,a
                                    415 ;	./main.c:27: delay(50000);
      00009D 90 C3 50         [24]  416 	mov	dptr,#0xC350
      0000A0 C0 07            [24]  417 	push	ar7
      0000A2 12 00 AF         [24]  418 	lcall	_delay
      0000A5 D0 07            [24]  419 	pop	ar7
                                    420 ;	./main.c:24: for(i=0;i<8;i++)
      0000A7 0F               [12]  421 	inc	r7
      0000A8 BF 08 00         [24]  422 	cjne	r7,#0x08,00136$
      0000AB                        423 00136$:
      0000AB 40 E1            [24]  424 	jc	00108$
      0000AD 80 BC            [24]  425 	sjmp	00112$
                                    426 ;------------------------------------------------------------
                                    427 ;Allocation info for local variables in function 'delay'
                                    428 ;------------------------------------------------------------
                                    429 ;i                         Allocated to registers 
                                    430 ;------------------------------------------------------------
                                    431 ;	./main.c:32: void delay(u16 i)
                                    432 ;	-----------------------------------------
                                    433 ;	 function delay
                                    434 ;	-----------------------------------------
      0000AF                        435 _delay:
      0000AF AE 82            [24]  436 	mov	r6,dpl
      0000B1 AF 83            [24]  437 	mov	r7,dph
                                    438 ;	./main.c:34: while(i)
      0000B3                        439 00101$:
      0000B3 EE               [12]  440 	mov	a,r6
      0000B4 4F               [12]  441 	orl	a,r7
      0000B5 60 07            [24]  442 	jz	00104$
                                    443 ;	./main.c:35: i--;
      0000B7 1E               [12]  444 	dec	r6
      0000B8 BE FF 01         [24]  445 	cjne	r6,#0xFF,00114$
      0000BB 1F               [12]  446 	dec	r7
      0000BC                        447 00114$:
      0000BC 80 F5            [24]  448 	sjmp	00101$
      0000BE                        449 00104$:
      0000BE 22               [24]  450 	ret
                                    451 	.area CSEG    (CODE)
                                    452 	.area CONST   (CODE)
                                    453 	.area XINIT   (CODE)
